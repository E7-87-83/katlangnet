...
public class ParameterDetectorTests
{
    ...
    {
        var ast = ParseAndDetect("x.count");
    ...
    [Fact]
    public void Detect_FirstBuiltin_DirectCallMultiResult_UsesPreludeNameWithoutPackagingArgs()
    {
    ...
    {
        var diags = ParseAndDetectDiagnostics("F((1, a)) = a + b");
    ...
    {
        var diags = ParseAndDetectDiagnostics("F((1, x)) = a * x + b");
